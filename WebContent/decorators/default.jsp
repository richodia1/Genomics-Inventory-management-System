...
<script type="text/javascript" src="<c:url value='/script/inventory.js'/>"></script>
<decorator:head />
		...
		<td style="vertical-align: top; padding: 0;">
			...
			<div style="padding: 3px 6px; background-color: rgb(240, 240, 240);">
				<div style="float: right;">
					<span style="margin-right: 20px"><s:action name="settings" namespace="/" executeResult="true" ignoreContextParams="true" /></span>
					Item: <form method="get" action="<s:url namespace='/' action='item/index' />"><input name="q" style="width: 100px;" value="" /> <input type="submit" value="Search" /></form>
					Lot: <form method="get" action="<s:url namespace='/' action='search' />"><input name="q" style="width: 100px;" value="" /> <input type="submit" value="Search" /></form>
				</div>
