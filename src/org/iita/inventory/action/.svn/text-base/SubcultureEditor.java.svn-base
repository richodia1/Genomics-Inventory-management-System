...
public class SubcultureEditor extends QuantityUpdateEditor {
	 ...
	 * @param exportService 
	 */
	public SubcultureEditor(QuantityUpdateService service, LotService lotService, SelectionService selectionService, BarcodingService barcodingService, ExportService exportService) {
	...
	public String start() {
		...
		this.description.setTitle("Subculturing");
		this.description.setTransactionType(Type.OUT);
		this.description.setTransactionSubtype("SUBCULTURING");
		return Action.INPUT;
	}
